...
namespace event {
  ...
  constexpr inline event_t castling(pos_t kingfrom, pos_t kingto, pos_t rookfrom, pos_t rookto, piece_bitboard_t castlings, pos_t enpassant) {
    event_t e = 0x00;
    e = (e << 8) | enpassant;
    e = (e << 8) | compress_castlings(castlings);
    e = (e << 8) | rookto;
  ...
  constexpr inline event_t enpassant(pos_t from, pos_t to, pos_t killwhere, piece_bitboard_t castlings, pos_t enpassant) {
    event_t e = 0x00;
    e = (e << 8) | enpassant;
    e = (e << 8) | compress_castlings(castlings);
    e = (e << 8) | killwhere;
  ...
  constexpr inline event_t promotion(pos_t from, pos_t to, pos_t killwhat, pos_t becomewhat, piece_bitboard_t castlings, pos_t enpassant) {
    return promotion_from_basic(event::basic(from, to, killwhat, castlings, enpassant), becomewhat);
  }
