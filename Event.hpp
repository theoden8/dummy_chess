...
namespace event {
  ...
  constexpr inline pos_t compress_special_flags(piece_bitboard_t castlings, pos_t halfmoves=0) {
    pos_t comp = halfmoves; comp <<= 1;
  ...
  constexpr inline pos_t decompress_halfmoves(pos_t comp) {
    return comp >> 4;
  }
                                 ...
                                 pos_t enpassant=enpassantnotrace, pos_t enpassant_trace=enpassantnotrace)
  {
    ...
    e = (e << 8) | enpassant;
    e = (e << 8) | compress_special_flags(castlings, halfmoves);
    e = (e << 8) | killwhat;
    e = (e << 8) | to;
    e = (e << 8) | from;
    e = (e << 8) | BASIC_MARKER;
